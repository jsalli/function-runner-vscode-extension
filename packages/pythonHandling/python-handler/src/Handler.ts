...
export class Handler implements LanguageHandler<PythonLanguageId> {
  ...
  public runFunctionWithInputSets(runnableFunction: RunnableFunction<PythonLanguageId>, inputViewContent: string, returnSuccessForTest: boolean | undefined): Promise<string> {
    throw new Error('Method not implemented.');
  }
  
  public debugFunctionWithInputSets(runnableFunction: RunnableFunction<PythonLanguageId>, inputViewContent: string, returnSuccessForTest: boolean | undefined): Promise<string> {
    throw new Error('Method not implemented.');
  }
